        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "int", "int" ],
                    "patching_rect": [ 392.0, 405.0, 49.72857510702943, 22.0 ],
                    "text": "t i i"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 397.0, 462.0, 126.0, 22.0 ],
                    "text": "bf.make-a-melody.v01"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 368.0, 369.0, 107.82671320097779, 20.0 ],
                    "text": "<i>"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 392.0, 368.0, 50.0, 22.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 263.0, 462.0, 126.0, 22.0 ],
                    "text": "bf.make-a-melody.v01"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 478.0, 368.0, 40.0, 22.0 ],
                    "text": "s play"
                }
            },
            {
